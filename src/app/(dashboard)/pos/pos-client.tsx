        ...
        <div className="flex-1 overflow-y-auto p-3">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 2xl:grid-cols-6 gap-3">
            {filtrados.map(p => (
              ...
              >
                <div className="w-full aspect-[4/5] bg-secondary/30 flex items-center justify-center text-3xl font-bold text-muted-foreground/50 font-heading relative rounded-t-xl overflow-hidden group-hover:opacity-90 transition-opacity">
                  {p.imageUrl ? (
